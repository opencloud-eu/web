<template>
  <div>
    ...
    <template v-else>
      <space-members v-if="showSpaceMembers" class="oc-surface-container p-4 mb-2" />
      <file-shares v-else class="oc-surface-container p-4 mb-2" />
      <file-links v-if="showLinks" class="oc-surface-container p-4" />
    </template>
  </div>
</template>
