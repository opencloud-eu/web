...
import { CreateLinkModal } from '@opencloud-eu/web-pkg'
import { useAbility } from '@opencloud-eu/web-pkg'
import { LinkShare, isProjectSpaceResource } from '@opencloud-eu/web-client'
import { useCopyLink, useLinkTypes } from '@opencloud-eu/web-pkg'
import { useLoadingService } from '@opencloud-eu/web-pkg'
import { useModals, useUserStore, useCapabilityStore, useSharesStore } from '@opencloud-eu/web-pkg'
