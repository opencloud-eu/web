import { isSameResource, renameResource as _renameResource } from '@opencloud-eu/web-pkg'
import { isLocationSharesActive, isLocationTrashActive } from '@opencloud-eu/web-pkg'
import {
...
import { useIsResourceNameValid } from '@opencloud-eu/web-pkg'
