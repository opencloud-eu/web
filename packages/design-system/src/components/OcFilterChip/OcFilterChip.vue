<template>
  ...
  >
    <oc-button
      :id="id"
      class="oc-filter-chip-button oc-pill py-1 px-2 text-xs rounded-full h-[26px] max-w-40 gap-1 focus:z-[9]"
    ...
    <oc-button
      ...
      class="oc-filter-chip-clear px-1 rounded-r-full h-[26px] not-[.oc-filter-chip-toggle_.oc-filter-chip-clear]:ml-[1px] focus:z-[9]"
      appearance="filled"
