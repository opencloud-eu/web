...
| **Aktenschrank** | `.type_aktenschrank` | Sachgruppe (beliebig tief verschachtelbar) | aktenschrank, akte | protected (bis letzte Ebene) |
...
Der Aktenschrank repräsentiert die Sachgruppen-Hierarchie des Aktenplans:

```
11 Innere Verwaltung/                          ← .type_aktenschrank, protected
├── 11.11 Verwaltungssteuerung/                ← .type_aktenschrank, protected
├── 11.12 Kommunalverwaltung/                  ← .type_aktenschrank, protected
│   ├── 11.12.01 Organisationsangelegenheiten/ ← .type_aktenschrank, protected
│   │   ├── 11.12.01.03 Satzungen/             ← .type_aktenschrank, LETZTE EBENE → shielded
│   │   │   ├── 11.12.01.03-01 Entschädigungssatzung/  ← .type_akte
│   │   │   └── 11.12.01.03-02 Feuerwehrsatzung/       ← .type_akte
```

- Alle Aktenschränke **bis zur letzten Ebene** sind `protected` (Struktur fixiert)
- Die **letzte Sachgruppe** (direkt über den Akten) ist nur `shielded` (geerbt vom Parent)
...
├── 11 Innere Verwaltung/                                   .type_aktenschrank  protected
│   ├── 11.11 Verwaltungssteuerung/                         .type_aktenschrank  protected
│   ├── 11.12 Innere Verwaltungsangelegenheiten/            .type_aktenschrank  protected
│   │   ├── 11.12.01 Organisationsangelegenheiten/          .type_aktenschrank  protected
...
│   │   └── 11.12.02 Personalangelegenheiten/               .type_aktenschrank  protected
│   └── 11.13 Finanzverwaltung/                             .type_aktenschrank  protected
├── 12 Sicherheit und Ordnung/                              .type_aktenschrank  protected
└── 21 Schulträgeraufgaben/                                 .type_aktenschrank  protected
```
