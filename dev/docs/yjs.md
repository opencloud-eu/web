...
External updates to a document get also propagated to all peers through the SSE stream.
...
While the wrapper cannot act - loading, a PUT in flight, the room disconnected, the session conflicted, read-only -
